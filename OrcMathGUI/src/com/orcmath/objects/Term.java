...
//    	if(coefficient==0)return ""+0;
	...
	public static Term getCopy(Term term) {
		...
		if (!term.getType().equals("constant")){
		...
		if (!copy.getType().equals("rational") && 
			...
			System.out.println("The getCopy(Term) method is being called but the method is not yet defined for the type of term being copied.");
